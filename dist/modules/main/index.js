    ...
    let MarkdownBlock = class MarkdownBlock extends components_2.Module {
        ...
        render() {
            return (this.$render("i-panel", null,
                this.$render("i-panel", { id: 'pnlEditor', padding: { top: 30, bottom: 30, left: 50, right: 50 } },
                    this.$render("i-grid-layout", { templateColumns: ['1fr', '1fr'], gap: { column: 20 } },
                        this.$render("i-panel", { id: 'txtMarkdownPnl', width: '100%%', height: '100%', class: 'box' },
                            this.$render("i-panel", { class: 'box-header' },
                                this.$render("i-label", { caption: 'Editor' })),
                            this.$render("i-panel", { class: 'box-content' },
                                this.$render("i-panel", { class: 'form-group' },
                                    this.$render("i-input", { id: 'txtMarkdown', class: 'form-control', width: '100%', height: '100%', inputType: 'textarea', placeholder: 'Enter here', captionWidth: 0, font: { size: Theme.typography.fontSize }, onChanged: this.handleTxtAreaChanged })))),
                        this.$render("i-panel", { id: 'txtMarkdownPnl', width: '100%', height: '100%', class: 'box' },
                            this.$render("i-panel", { class: 'box-header' },
                                this.$render("i-label", { caption: 'Preview' })),
                            this.$render("i-panel", { class: 'box-content' },
                                this.$render("i-panel", { class: 'form-group' },
                                    this.$render("i-markdown", { id: 'mdPreview', class: 'form-control', width: 'auto', height: 'auto', padding: { top: '10px', bottom: '10px', left: '10px', right: '10px' }, onDblClick: this.handleMarkdownViewerDblClick })))))),
                this.$render("i-panel", { id: 'pnlViewer' },
                    this.$render("i-markdown", { id: 'mdViewer', width: '100%', height: '100%', padding: { top: '10px', bottom: '10px', left: '10px', right: '10px' }, onDblClick: this.handleMarkdownViewerDblClick }))));
        }
    };
